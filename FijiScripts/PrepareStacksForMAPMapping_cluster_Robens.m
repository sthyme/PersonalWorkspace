max = 2000; // set the max value of the images here - either 65535 for uint16, or 4096 if uint12 mapped
...
open(source_file);
run("Size...", "width=640 depth=12 constrain average interpolation=Bilinear");
