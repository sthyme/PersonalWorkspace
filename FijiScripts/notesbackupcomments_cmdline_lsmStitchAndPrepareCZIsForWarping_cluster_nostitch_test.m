...
tile2name = Prefix[0] + "(" + toString(numbertile2) + ")" + number[1]
	...
	//run("Merge Channels...", "c1=" + "C1-"+FilePrefix + " c2=" + "C2-"+FilePrefix  + " keep");
	//rename("Tile1");
	//run("Merge Channels...", "c1=" + "C1-" + FilePrefix + " c2=" + "C2-" + FilePrefix + " c3=" + "C3-" + FilePrefix+ " keep");
	//selectWindow(FilePrefix);
	selectWindow("Composite");
	rename("Tile1");

	//saveName = saveName0 + "_MERGE.nrrd";
...
//	run("Nrrd ... ", "nrrd=[saveName]");
	...
	selectWindow("Composite");
	rename("Tile2");
	//saveName = saveName0 + "_MERGET2.nrrd";
	//run("Nrrd ... ", "nrrd=[saveName]");
