max = 4096; // set the max value of the images here - either 65535 for uint16, or 4096 if uint12 mapped
...
open(source_file);
run("Size...", "width=300 depth=160 constrain average interpolation=Bilinear");
