min = 30; // set the max value of the images here - either 65535 for uint16, or 4096 if uint12 mapped
max = 100; // set the max value of the images here - either 65535 for uint16, or 4096 if uint12 mapped
